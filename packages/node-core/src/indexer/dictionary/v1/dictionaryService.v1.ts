...
import {CoreMetadata} from '../../dictionary/types';
...
@Injectable()
export class DictionaryServiceV1 {
  ...
  private convertMetaToCore(metaV1: DictionaryV1Metadata): CoreMetadata {
    return {
      startHeight: metaV1.startHeight,
      endHeight: metaV1.lastProcessedHeight,
      genesisHash: metaV1.genesisHash,
      chain: metaV1.chain,
    };
  }
  ...
  async getMetadata(): Promise<CoreMetadata | undefined> {
    ...
    try {
      ...
      return this.convertMetaToCore(_metadata);
    } catch (err: any) {
